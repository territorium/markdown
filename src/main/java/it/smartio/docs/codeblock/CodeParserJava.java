...
class CodeParserJava extends CodeParserDefault {
	...
	private static final Pattern JAVA = Pattern
			.compile(String.format("(%s)", String.join("|", CodeParserJava.KEYWORDS)), Pattern.CASE_INSENSITIVE);
	 ...
	 * @param builder
	 */
	public CodeParserJava(SectionBuilder builder) {
		super(builder);
	}
