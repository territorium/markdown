...
public class FoPageSequenceMaster extends FoNode {
	...
	public enum BlankOrNot {
		...
		Blank("blank"), NotBlank("not-blank "), Any("any");
	...
	public enum Position {
		...
		First("first"), Last("last"), Rest("rest"), Any("any"), Only("only");
	...
	public FoPageSequenceMaster(String name) {
		...
		this.master = FoNode.of("fo:repeatable-page-master-alternatives");
	...
	public FoNode addBlank(String reference, BlankOrNot blankOrNot) {
		FoNode builder = FoNode.of("fo:conditional-page-master-reference");
	...
	public FoNode addPage(FoSimplePageMaster page, Position position, OddOrEven oddOrEven) {
		return addPage(page.getPageName(), position.value, oddOrEven.value);
	}

	public FoNode addPage(String page, String position, String oddOrEven) {
		FoNode builder = FoNode.of("fo:conditional-page-master-reference");
		builder.set("master-reference", page);
